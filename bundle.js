...
/***/ function(module, exports, __webpack_require__) {
	...
	var thoughtEvents = __webpack_require__(9);
	var thoughtUI = __webpack_require__(11);
	var voteEvents = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showSignButtons = function showSignButtons() {
	  $('#sign-in-button').show();
	  $('#sign-up-button').show();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowThought = function onShowThought(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.showThought(data).done(ui.success).fail(ui.failure);
	};

	var addIdUpdateButton = function addIdUpdateButton(event) {
	  event.preventDefault();
	  var id = $(event.target).attr("data-thought-id");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createThought = function createThought(data) {
	  var token = app.user.token;
	  return $.ajax({
	...
	var indexThoughts = function indexThoughts() {
	  var token = app.user.token;
	  return $.ajax({
	    url: app.host + '/thoughts',
	    method: 'GET',
	...
	var myThoughts = function myThoughts() {
	  var token = app.user.token;
	  return $.ajax({
	...
	var showThought = function showThought(data) {
	  var token = app.user.token;
	  var thought_id = data.thought.id;
	  return $.ajax({
	...
	var updateThought = function updateThought(data, id) {
	  var token = app.user.token;
	  return $.ajax({
	...
	var deleteThought = function deleteThought(id) {
	  var token = app.user.token;
	  return $.ajax({
	    url: app.host + '/thoughts/' + id,
	    method: 'DELETE',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexThoughtsTemplate = __webpack_require__(12);
	var myThoughtsTemplate = __webpack_require__(33);

	var onTogglePollForm = function onTogglePollForm() {
	...
	var createThoughtSuccess = function createThoughtSuccess() {
	  clearInputField();
	};

	var createThoughtFail = function createThoughtFail() {
	  clearInputField();
	};

	var indexThoughtsSuccess = function indexThoughtsSuccess(thoughts) {
	  $('.content-display').html(indexThoughtsTemplate(thoughts));
	};

	var myThoughtsSuccess = function myThoughtsSuccess(thoughts) {
	  $('.content-display').html(myThoughtsTemplate(thoughts));
	};

	var updateThoughtSuccess = function updateThoughtSuccess() {
	  clearInputField();
	...
	var setTextareaContent = function setTextareaContent(event) {
	  event.preventDefault();
	  var content = $(event.target).attr("data-thought-content");
	...
	module.exports = {
	  addHandlers: addHandlers,
	  createThoughtSuccess: createThoughtSuccess,
	  createThoughtFail: createThoughtFail,
	  indexThoughtsSuccess: indexThoughtsSuccess,
	  myThoughtsSuccess: myThoughtsSuccess,
	  updateThoughtSuccess: updateThoughtSuccess,
	  success: success,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"index-thoughts-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h2> Thoughts </h2>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.thoughts : depth0), depth0),{"name":"thoughts","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <p>"
	    ...
	    + "</p>\n\n  <form id=\"vote-results\">\n    <input type=\"hidden\" class=\"form-control input\" name=\"vote[id]\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n    <button type=\"submit\" name=\"submit\" class=\"btn btn-xs btn-primary pull-right\">Results</button>\n  </form>\n\n  <form id=\"create-vote\">\n    <fieldset>\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["0"] : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["1"] : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["2"] : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "      <input type=\"hidden\" name=\"vote[thought_id]\" value=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n      <div class=\"vote-button\">\n        <button type=\"submit\" class=\"btn btn-xs btn-primary\" name=\"submit\">Vote</button>\n      </div>\n    </fieldset>\n  </form>\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "        <input type=\"radio\" name=\"vote[choice]\" value=\"a\"> "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["0"] : stack1), depth0))
	    + " <br>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "        <input type=\"radio\" name=\"vote[choice]\" value=\"b\"> "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["1"] : stack1), depth0))
	    + " <br>\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "        <input type=\"radio\" name=\"vote[choice]\" value=\"c\"> "
	    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.answers : depth0)) != null ? stack1["2"] : stack1), depth0))
	    + " <br>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, alias1=container.escapeExpression, alias2=depth0 != null ? depth0 : {};

	  return "<p class=\"thought\">\n  User "
	    + alias1(container.lambda(((stack1 = (depth0 != null ? depth0.user : depth0)) != null ? stack1.id : stack1), depth0))
	    + ": \""
	    + alias1(((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias2,{"name":"content","hash":{},"data":data}) : helper)))
	    + "\"\n</p>\n\n"
	    + ((stack1 = helpers["if"].call(alias2,(depth0 != null ? depth0.question : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"my-thoughts-partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h2> My Thoughts </h2>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.thoughts : depth0), depth0),{"name":"thoughts","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<p class=\"thought\">\n  \""
	    ...
	    + "\"\n\n  <button class=\"btn btn-primary btn-xs update-thought\" data-toggle=\"modal\" data-target=\"#updateThoughtModal\" data-thought-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + " data-thought-content=\""
	    + alias4(((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper)))
	    + "\">Edit</button>\n  <button class=\"btn btn-danger btn-xs delete-thought\" data-toggle=\"modal\" data-target=\"#deleteThoughtModal\" data-thought-id="
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + ">Delete</button>\n\n</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateVote = function onCreateVote(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createVote(data).done(ui.success).fail(ui.failure);
	};

	var onVoteResults = function onVoteResults(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.voteResults(data).done(ui.voteResultsSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var voteResults = function voteResults(data) {
	  var token = app.user.token;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var voteResultsSuccess = function voteResultsSuccess(data) {
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  voteResultsSuccess: voteResultsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
